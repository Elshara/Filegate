...
function fg_render_layout(string $title, string $body, array $options = []): void
{
    ...
    $layoutEnabled = fg_get_asset_parameter_value('assets/php/render_layout.php', 'enabled', $context);
    $layoutMode = fg_get_asset_parameter_value('assets/php/render_layout.php', 'mode', $context);
    $layoutVariant = fg_get_asset_parameter_value('assets/php/render_layout.php', 'variant', $context);
    ...
    echo '<script src="/assets/js/detect_embed.js" defer></script>';
    echo '<script src="/assets/js/render_embed_fragment.js" defer></script>';
    echo '<script src="/assets/js/extract_urls.js" defer></script>';
    echo '<script src="/assets/js/sanitize_preview_html.js" defer></script>';
    echo '<script src="/assets/js/calculate_preview_statistics.js" defer></script>';
    echo '<script src="/assets/js/register_ajax_forms.js" defer></script>';
    echo '<script src="/assets/js/register_post_preview.js" defer></script>';
    echo '<script src="/assets/js/register_upload_inputs.js" defer></script>';
    echo '<script src="/assets/js/register_embed_observer.js" defer></script>';
    echo '<script src="/assets/js/register_dataset_viewer.js" defer></script>';
    echo '<script src="/assets/js/register_theme_preview.js" defer></script>';
    echo '<script src="/assets/js/init_client.js" defer></script>';
    echo $themeStyle;
    echo $extra_head;
    echo '</head>';
